                                    ...
                                    DataRow(
                                      ...
                                      DataCell(
                                        IconButton(
                                          ...
                                          onPressed: () async {
                                            bool? result = await DeleteProduct.delete(
                                              filteredData[i][0], // Assuming index 1 is productName
                                              // filteredData[i][2], // Assuming index 2 is variant
                                            );
                                            if (result == true) {
                                              setState(() {
                                                fetchProductsLocal(allProducts);
                                              });
                                              showCustomSuccessDialog("Product deleted!", context);
                                            }
                                          },
                                        ),
                                      ),
                                        ...
                                        DataRow(cells: [
                                          ...
                                          DataCell(
                                            IconButton(
                                              ...
                                              onPressed: () async {
                                                bool? result = await DeleteProduct.delete(
                                                  filteredDataExpired[i][0], // Assuming index 1 is productName
                                                  // filteredData[i][2], // Assuming index 2 is variant
                                                );
                                                if (result == true) {
                                                  setState(() {
                                                    fetchProductsLocal(allExpiredProducts);
                                                  });
                                                  showCustomSuccessDialog("Product deleted!", context);
                                                }
                                              },
