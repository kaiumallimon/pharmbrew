...
import '../../../data/_fetch_leave_requests.dart';
...
class _WebDashboardState extends State<WebDashboard> {
  ...
  void initState() {
    ...
    timer3 = Timer.periodic(const Duration(milliseconds: 500), (Timer t) {
      fetchLeaveData();
    });
  }
                          ...
                          children: [
                            ...
                            widget.isAdministrator
                                ? SidePanelButton(
                                    ...
                                    controller: inFocus == 26,
                                    onClick: () {
                                      setState(() {
                                        inFocus = 26;
                                      });
                                    },
                                    notificationDot: getLeaveRequestsCount() > 0 ? true : false,
                                  )
                                : const SizedBox.shrink(),
